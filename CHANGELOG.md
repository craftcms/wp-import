...
- Renamed `craft\wpimport\Command\EVENT_REGISTER_GENERATOR_TYPES` to `EVENT_REGISTER_GENERATORS`.
...
## 1.6.0 - 2023-08-10
- Added `craft\wpimport\BaseGenerator::messageTwig()`. ([#25](https://github.com/craftcms/generator/pull/25))
...
- Added `craft\wpimport\BaseGenerator::findModuleMethod()`.
